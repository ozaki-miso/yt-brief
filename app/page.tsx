                ...
                <div className={`mb-6 rounded-xl px-5 py-3 text-sm font-medium flex items-center justify-between ${
                  ...
                  <span>
                    {result.remaining === 0
                      ...
                      : result.remaining === 1
                      ? "⚠️ Last free brief — upgrade to keep going"
                ...
                <div className="p-5 sm:p-12 space-y-8 sm:space-y-12">
                  ...
                  <div className="mt-10 pt-8 border-t border-white/5 space-y-6">
                    ...
                    <div className="rounded-2xl bg-gradient-to-r from-sky-950/60 to-zinc-900/60 border border-sky-500/20 px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
                      ...
                      <Link
                        href="/pricing"
                        className="shrink-0 bg-sky-500 hover:bg-sky-400 text-white font-bold px-5 py-2.5 rounded-xl text-xs transition-all shadow-[0_0_20px_rgba(56,189,248,0.3)] hover:shadow-[0_0_30px_rgba(56,189,248,0.5)] active:scale-95"
                      >
                        See Plans →
                      </Link>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <p className="text-zinc-700 text-[10px] font-bold tracking-widest uppercase">
                        Powered by YT-brief Engine
                      </p>
